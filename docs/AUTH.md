...
```
AUTH PROVIDER (approved: Supabase Auth — NOT wired yet; later phase)
      ↓
...
- No auth provider wired (no cookies, sessions, login/signup flows) — 1B-05 is
  the boundary only; Supabase Auth arrives in a later approved phase.
