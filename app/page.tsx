 ...
 *
 * Intentionally minimal: it exists to prove the application compiles, serves,
 * and that Tailwind CSS works. The Guardian dashboard arrives in a later phase.
 */
    ...
    <main className="flex min-h-screen flex-col items-center justify-center px-6">
      <section className="w-full max-w-xl rounded-2xl border border-neutral-800 bg-neutral-900/60 p-10 text-center shadow-xl">
        ...
        <p className="mt-6 text-sm leading-relaxed text-neutral-400">
          Foundation-only development build. Monitoring, diagnostics, health scoring, and AI modules
